...
SQL näide:
sqlCREATE TABLE Registreerimine (
    õpilane_id  INT,
    kursus_id   INT,
    kuupäev     DATE,
...
SQL näide:
sqlCREATE TABLE Õpilane_Kursus (
